...
const NoChatHistoryPlaceholder = ({ name }) => {
  return (
    <div className="flex flex-col items-center justify-center py-40 text-center space-y-4">
      ...
      <h3 className="text-lg font-medium text-amber-200 mb-3">
      ...
      <div className="flex flex-wrap gap-2 justify-center">
        <button className="px-4 py-2 text-xs font-medium text-amber-400 bg-amber-500/10 rounded-full hover:bg-amber-500/20 transition-colors">
          👋 Say Hello
        </button>
        <button className="px-4 py-2 text-xs font-medium text-amber-400 bg-amber-500/10 rounded-full hover:bg-amber-500/20 transition-colors">
          🤝 How are you?
